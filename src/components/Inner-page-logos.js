...
const Homelogos = () => {
  return (
    <>
      ...
      <div class="grid grid-cols-4 pb-20 gap-12 max-w-[1000px] m-auto  text-left mobile:gap-4 mobile:grid-cols-2 tablet:gap-4">
    <div class="bg-[#f0f0f0] p-5 border border-gray-300">
      <p class="text-5xl font-light">987</p>
      <b>Websites Designed</b>
    </div>
    <div class="bg-[#f0f0f0] p-5 border border-gray-300">
      <p class="text-5xl font-light">25</p>
      <b>Global Awards Won</b>
    </div>
    <div class="bg-[#f0f0f0] p-5 border border-gray-300">
      <p class="text-5xl font-light">20+</p>
      <b>Certified Experts</b>
    </div>
    <div class="bg-[#f0f0f0] p-5 border border-gray-300">
      <p class="text-5xl font-light">50+</p>
      <b>in Listed Best Agency</b>
    </div>
  </div>

              <div className="max-w-[765px] mx-auto flex flex-col relative before:content-[''] before:bg-[#f0f2f5] before:w-[580px] before:h-[2px] before:absolute before:right-[50%] before:mr-[-290px] before:top-[0] before:z-0 pt-20 full_all_m mobile:before:hidden mobile:border-t-[#f0f2f5] mobile:border-t-2 mobile:pt-10"> 
